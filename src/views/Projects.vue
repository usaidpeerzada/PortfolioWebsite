<template>
  <div class="container projects w-screen">
    <link
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg bg-teal-200">
          ...
          <div class="px-6 py-4">
            ...
            <p class="text-gray-700 text-base">
              ...
              NodeJs, ExpressJs, MongoDB, EJS. You can check out the code or use
              this for your own projects, just clone it on github.
            </p>
          </div>
          <div class="px-6 py-4">
            <span
